        ...
        Schema::create('articles', function (Blueprint $table) {
           ...
           // Marque avec limite de taille (facultatif)
            ...
            // Quantité en stock avec un type integer et contrainte positive
              ...
              // Prix avec type decimal, précision 8 pour les chiffres avant la virgule et 2 après
              $table->decimal('prix', 8, 2);

              // Image avec limite de taille (255 caractères)
               $table->string('imageart', 190)->nullable();
        
               // Clé étrangère vers la sous-catégorie
